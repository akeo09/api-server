...
const sendVerificationEmail = (toEmail, username, token) => {
    sendOneButtonEmail({
        to: toEmail,
        from: { name: 'The Study Buddy', email: 'keoalicia09@gmail.com' },
        subject: 'Welcome to The Study Buddy!',
        imgURL: 'http://cdn.mcauto-images-production.sendgrid.net/f684846d371aa718/32a705a1-43bd-42a8-aa96-9286be5e4f09/840x859.png',
        firstLine: `Thanks for signing up, ${username}!`,
        secondLine: 'Please verify your email address to begin studying with buddies.',
        thirdLine: 'Thank you!',
        buttonURL: `https://nice-moss-0d1bf5d0f.4.azurestaticapps.net/verify.html?token=${token}`,
